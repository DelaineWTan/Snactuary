    ...
    public static var pets: [Int: Pet] = [
        ...
        9: Pet(petName:"Brear",
               ...
               baseAbility: OrbitingProjectileAbility(
                ...
                _InputAbilityDuration: 10,
                _InputRotationSpeed: 6,
                _InputDistanceFromCenter: 12,
                _InputNumProjectiles: 2,
        ...
        10: Pet(petName:"Gum Brear",
                ...
                baseAbility: ShootClosestAbility(
                    ...
                    _InputProjectileSpeed: 30,
                    _InputProjectileDuration: 1,
                    _InputProjectile: {()->Projectile in LaunchedProjectile(_InputDamage: 3, assetName: "Honeypot")}),
                currentExp: 0,
                level: 1
               ),
        11: Pet(petName:"Pol Brear",
                ...
                attack: 3,
                baseAbility: SpawnProjectileInRangeAbility(_InputSpawnRate: 3, _InputRange: 15, _InputProjectileDuration: 3, _InputProjectile: {
                    ()-> Projectile in StationaryBomb(_InputDamage: 3, assetName: "Honeypot")
                }),
                currentExp: 0,
        ...
        12: Pet(petName:"Sad Doger",
                ...
                baseAbility: OrbitingProjectileAbility(
                    ...
                    _InputDistanceFromCenter: 6,
                    _InputNumProjectiles: 3,
                    _InputProjectile: { ()->Projectile in OrbitingPaw(_InputDamage: 2, assetName: "Dogbone")}),
                currentExp: 0,
                level: 1 // Assuming from context
               ),
        13: Pet(petName:"Lucky Doger",
                ...
                baseAbility: ShootClosestAbility(
                    ...
                    _InputProjectileDuration: 1.5,
                    _InputProjectile: {()->Projectile in LaunchedProjectile(_InputDamage: 2, assetName: "Dogbone")}),
                currentExp: 0,
                level: 1 // Assuming from context
               ),
        14: Pet(petName:"Sparky Doger",
                ...
                attack: 2,
                baseAbility: SpawnProjectileInRangeAbility(_InputSpawnRate: 2, _InputRange: 10, _InputProjectileDuration: 2, _InputProjectile: {
                    ()-> Projectile in StationaryBomb(_InputDamage: 2, assetName: "Dogbone")
                }),
                currentExp: 0,
                level: 1 // Assuming from context
               ),
